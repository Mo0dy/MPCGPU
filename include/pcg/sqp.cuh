...
auto sqpSolvePcg(const uint32_t state_size, const uint32_t control_size,
  ...
  //
  printf("===========================\n");
  printf("Starting SQP solve with initial merit %f\n", (double)h_merit_initial);
